...
class ListaEnlazada{
    ...
    //print         Funcion para mostrar los datos de la lista
    print(){
        let current = this.head;
        while(current){
...
LISTA.insertAfter(888);
LISTA.insertAfter(8888);
...
LISTA.removeFirst();
console.log("Lista con el primer nodo eliminado : ");
LISTA.print();

// Remover el último nodo
LISTA.removeLast();
console.log("Lista actualizada sin el último nodo: ");
LISTA.print();
